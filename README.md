...
4. You will get last minute instructions that will ask you to save all open work and close all applications but not Terminal-window. User will get separate prompt at the end of the onboarding where user are asked to reboot the device and after rebooting the device, open Company Portal adn sign in using user's Work or School account.
