...
| [Microsoft 365 applications ans services](https://microsoft365.com/)<br>(e.g. Outlook, Teams, Word, Excel, PowerPoint and Visio) | Office activities | web/PWA | Use Microsoft Edge -browser for these services. Please note that Microsoft does not provide native application of Teams for any Linux distros. |
